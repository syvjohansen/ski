...
mendf = pd.read_pickle("~/ski/ranks/alpine/excel365/mendf.pkl")
...
varmenelo.to_pickle("~/ski/ranks/alpine/excel365/varmen_points.pkl")
varmenelo.to_excel("~/ski/ranks/alpine/excel365/varmen_points.xlsx")
