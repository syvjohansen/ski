...
mendf = pd.read_pickle("~/ski/ranks/skijump/excel365/mendf.pkl")
...
#varmendf = dates(varmendf, 20200501, 20210500)
...
varmenelo.to_pickle("~/ski/ranks/skijump/excel365/varmen_points.pkl")
varmenelo.to_excel("~/ski/ranks/skijump/excel365/varmen_points.xlsx")
