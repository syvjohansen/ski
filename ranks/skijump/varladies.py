...
ladiesdf = pd.read_pickle("~/ski/ranks/skijump/excel365/ladiesdf.pkl")
...
#varladiesdf = dates(varladiesdf, 20200501, 20210500)
...
varladieselo.to_pickle("~/ski/ranks/skijump/excel365/varladies_points.pkl")
varladieselo.to_excel("~/ski/ranks/skijump/excel365/varladies_points.xlsx")
