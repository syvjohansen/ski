...
mendf = pd.read_pickle("~/ski/ranks/nc/excel365/mendf.pkl")
...
#varmendf = dates(varmendf, 20200501, 20210400)
...
varmenelo.to_pickle("~/ski/ranks/nc/excel365/varmen_points.pkl")
varmenelo.to_excel("~/ski/ranks/nc/excel365/varmen_points.xlsx")
