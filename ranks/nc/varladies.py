...
ladiesdf = pd.read_pickle("~/ski/ranks/nc/excel365/ladiesdf.pkl")
...
varladieselo.to_pickle("~/ski/ranks/nc/excel365/varladies_points.pkl")
varladieselo.to_excel("~/ski/ranks/nc/excel365/varladies_points.xlsx")
