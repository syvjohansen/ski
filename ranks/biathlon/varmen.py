...
mendf = pd.read_pickle("~/ski/ranks/biathlon/excel365/mendf.pkl")
...
#varmendf = dates(varmendf, 0, 20190500)
...
varmenelo.to_pickle("~/ski/ranks/biathlon/excel365/varmen_points.pkl")
varmenelo.to_excel("~/ski/ranks/biathlon/excel365/varmen_points.xlsx")
