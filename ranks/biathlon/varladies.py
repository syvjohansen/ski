...
ladiesdf = pd.read_pickle("~/ski/ranks/biathlon/excel365/ladiesdf.pkl")
...
varladieselo.to_pickle("~/ski/ranks/biathlon/excel365/varladies_points.pkl")
varladieselo.to_excel("~/ski/ranks/biathlon/excel365/varladies_points.xlsx")
