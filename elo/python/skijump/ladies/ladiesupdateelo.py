...
refdf = pd.read_pickle("~/ski/elo/python/skijump/excel365/ladyelo2.pkl")
	#print(refdf)
...
#print(refdf["id"])
#print(df['id'])
df.to_pickle("~/ski/elo/python/skijump/excel365/ladiesupdate.pkl")
df.to_excel("~/ski/elo/python/skijump/excel365/ladiesupdate.xlsx")
