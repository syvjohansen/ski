...
refdf = pd.read_pickle("~/ski/elo/python/skijump/excel365/menelodf2.pkl")
	#print(refdf)
...
df = setup()
df.to_pickle("~/ski/elo/python/skijump/excel365/menupdate_setup.pkl")
df = elo(refdf, df)
df.to_pickle("~/ski/elo/python/skijump/excel365/menupdate.pkl")
df.to_excel("~/ski/elo/python/skijump/excel365/menupdate.xlsx")
