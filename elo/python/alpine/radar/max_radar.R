...
ladies = read_excel("/Users/syverjohansen/ski/elo/python/alpine/radar/max_lady_values.xlsx", sheet="Sheet1", col_names=TRUE, na="NA")
ladies
ladies = data.frame(ladies[,2:9])
which(ladies$Name=="Ana Kobal")
ladies$Name[1594] = "Ana Kobal2"
