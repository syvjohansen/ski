   ...
   # print(id_dict)
    ...
    #for season in range(10):
        ...
        for idd in ski_ids_s:
            ...
            endf = pd.DataFrame([[endseasondate, "Summer", "Break", "end", "M", None, None
...
menelodf.to_pickle("~/ski/elo/python/alpine/excel365/menelodf2.pkl") #changed
menelodf.to_excel("~/ski/elo/python/alpine/excel365/menelodf2.xlsx") #changed
