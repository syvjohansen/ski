...
K=1
ladiesdf = pd.read_pickle("~/ski/elo/python/biathlon/ladiesdf.pkl")
...
ladieselodf.to_pickle("~/ski/elo/python/biathlon/ladieselodf2.pkl") #changed
ladieselodf.to_excel("~/ski/elo/python/biathlon/ladieselodf2.xlsx") #changed
