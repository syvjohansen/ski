...
refdf2 = pd.read_pickle("~/ski/elo/python/biathlon/ladies/varladies.pkl")
#refdf2 = pd.read_pickle("~/ski/elo/python/biathlon/ladies/varladies_distance.pkl")
#refdf2 = pd.read_pickle("~/ski/elo/python/biathlon/ladies/varladies_all.pkl")
...
df = pd.DataFrame(d)
df.to_excel("~/ski/elo/python/biathlon/winprob/varladieswinprob.xlsx")
