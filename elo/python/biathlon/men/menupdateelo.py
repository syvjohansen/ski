...
refdf = pd.read_pickle("~/ski/elo/python/biathlon/men/menelodf2.pkl")
	#print(refdf)
...
df = setup()
df.to_pickle("~/ski/elo/python/biathlon/men/menupdate_setup.pkl")
df = elo(refdf, df)
df.to_pickle("~/ski/elo/python/biathlon/men/menupdate.pkl")
df.to_excel("~/ski/elo/python/biathlon/men/menupdate.xlsx")
